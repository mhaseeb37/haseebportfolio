...
//   };
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('/api/send-email', {
      ...
      body: JSON.stringify({
        to: 'mhaseeb37@gmail.com',
        subject: 'Test Email',
        message: 'This is a test email sent using Postmark!',
      }),
    });
        ...
        <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
          ...
          <ul className="mt-16 space-y-8">
            <li className="flex items-center">
              ...
              <Link href="mailto:mhaseeb37@gmail.com" className="text-white text-sm text-gray-500 ml-4">
                mhaseeb37@gmail.com
              </Link>
            </li>
            <li className="flex items-center">
              ...
              <Link href="tel:+923224225997" className="text-white text-sm text-gray-500 ml-4">
                +92 322 422 5997
              </Link>
            </li>
            <li className="flex items-center">
              ...
              <Link href="https://maps.app.goo.gl/NvRZgVvwQUTE9Lzo9" target="_blank" className="text-white text-sm text-gray-500 ml-4">
                Lahore, Pakistan
              </Link>
            </li>
          </ul>
