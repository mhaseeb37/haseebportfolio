            ...
            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                ...
                <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <ul className="mt-16 space-y-8">
                        ...
                        <li className="flex items-center">
                            <svg  width="16px" height="16px" fill='#fff' viewBox="0 0 482.6 482.6">
                        ...
                        <li className="flex items-center">
                            <svg  width="16px" height="16px" fill='#fff' viewBox="0 0 368.16 368.16">
                    ...
                    <form>
                        <div className="grid sm:grid-cols-2 gap-8">
                            <div className="relative flex items-center">
                                ...
                                <svg  fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
                                    viewBox="0 0 24 24">
                        ...
                        <button type="button"
                            ...
                            <svg  width="16px" height="16px" fill='#fff' className="mr-2" viewBox="0 0 548.244 548.244">
