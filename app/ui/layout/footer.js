    ...
    return(
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="lg:flex lg:items-center">
          <Link href="">
            <Image src="https://readymadeui.com/readymadeui-light.svg"
             alt="logo" 
             className="w-52" 
             width={100}
             height={100}
        ...
        <div className="lg:flex lg:items-center">
          <ul className="flex space-x-6">
            <li>
              <Link href="">
                <svg className="fill-gray-300 hover:fill-white w-7 h-7" viewBox="0 0 24 24">
            ...
            <li>
              <Link href="">
                <svg fill="none" className="fill-gray-300 hover:fill-white w-7 h-7"
                  viewBox="0 0 24 24">
                  <path
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <Link href="" className="text-gray-300 hover:text-white text-sm">Email</Link>
            </li>
            <li>
              <Link href="" className="text-gray-300 hover:text-white text-sm">Phone</Link>
            </li>
            <li>
              <Link href="" className="text-gray-300 hover:text-white text-sm">Address</Link>
            </li>
          </ul>
        </div>
