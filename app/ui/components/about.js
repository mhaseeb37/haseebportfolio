...
export default function About() {
  return (
    <div id="aboutme" className={`${poppins.className} aboutwrapper pt-10 md:pt-32 w-full md:max-w-3xl lg:max-w-4xl xl:max-w-6xl text-black`}>
      <div className="mainWrapper">
        ...
        <div className="grid grid-cols-12 mt-8 gap-4 py-4">
          ...
          <div className="col-span-12 mx-8 mt-5 md:col-span-4 relative border bg-[#ffdb67] p-10 border-black before:block before:absolute before:-inset-0 before:rotate-2 before:w-full before:border before:border-black before:-z-[1] before:transition-transform before:duration-300 after:block after:absolute after:-inset-0 after:-rotate-2 after:w-full after:border after:border-black after:-z-[1] after:transition-transform after:duration-300 hover:before:rotate-0 hover:after:rotate-0">
